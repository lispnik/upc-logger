...
(defpackage #:upc-logger
  ...
  (:export
   ...
   #:entry-at #:entry-name #:entry-note #:entry-photo #:entry-shared-photo
   #:annotated-p #:attach-shared-photo
   ;; rows: a run of scans drawn as one, or every scan on its own
   #:group #:group-events #:group-first-event #:group-code #:group-name
   #:group-note #:group-photo #:group-shared-photo #:group-display-photo
   #:group-count #:group-scans
